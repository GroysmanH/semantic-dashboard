...
export type RetryText = string;
export type Retryable1 = boolean;
export type TargetBoardId1 = string | null;
export type TargetCardId = string | null;
...
export type QualityWarnings = string[];
...
export interface ChatMessageOut {
  ...
  recovery?: ChatRecoveryView | null;
  refusal?: Refusal;
 ...
 */
export interface ChatRecoveryView {
  retry_text?: RetryText;
  retryable?: Retryable1;
  target_board_id?: TargetBoardId1;
