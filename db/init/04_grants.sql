...
GRANT USAGE ON SCHEMA stg, ddh, dm_planning TO warehouse_ro;
GRANT SELECT ON ALL TABLES IN SCHEMA stg, ddh, dm_planning TO warehouse_ro;
ALTER DEFAULT PRIVILEGES IN SCHEMA stg, ddh, dm_planning
