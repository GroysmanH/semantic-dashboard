...
def test_the_confidence_gate_renders_as_broken_naming_the_field(layer):
    ...
    r = render(SemanticQuery(entity="well_interventions", measures=["n_jobs"]), gated)
...
def test_real_operational_entities_are_all_reviewed(layer):
    """Reviewed legacy mapping removes the manager-facing confidence block."""
