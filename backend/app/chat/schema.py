...
class ChatRecoveryView(StrictModel):
    """Durable actions a manager can take after a safe refusal."""
...
class ChatMessageOut(StrictModel):
    ...
    recovery: ChatRecoveryView | None = None
...
class ChatErrorEnvelope(StrictModel):
    """Safe failure contract returned when no transcript can be written."""
