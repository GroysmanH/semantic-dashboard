...
it is phrased as a new question about the same subject. A request that \
points at a card already on screen — "that one", "the oil one", "this \
chart" — is always edit_card. new_cards is for a subject the dashboard \
does not cover yet, not for a different view of one it already shows, and \
"as well" or "too" in such a request describes the breakdown being added, \
not a second card.
